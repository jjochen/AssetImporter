...
struct Resource {
    ...
    static var add16ptRoundedSVG: Resource {
        ...
        let size = CGSize(width: 16, height: 16)
        // swiftlint:disable line_length
        let svgString = "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' width='32' height='32'><title>add_16pt</title><g class='nc-icon-wrapper' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' fill='#444444' stroke='#444444'><line data-color='color-2' fill='none' stroke-miterlimit='10' x1='16' y1='9' x2='16' y2='23'/> <line data-color='color-2' fill='none' stroke-miterlimit='10' x1='23' y1='16' x2='9' y2='16'/> <circle fill='none' stroke='#444444' stroke-miterlimit='10' cx='16' cy='16' r='15'/></g></svg>"
        // swiftlint:enable line_length
        return Resource(fileName: fileName, size: size, svgString: svgString)
    }
